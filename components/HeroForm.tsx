      ...
      <div className="flex flex-col gap-3 rounded-3xl border border-black/10 bg-sand p-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3.5 sm:rounded-full sm:py-2.5 sm:pr-2.5 sm:pl-7">
        <div className="flex min-w-0 items-center gap-2.5 sm:contents">
          ...
          <input
            ...
            className="min-w-0 flex-1 border-0 bg-transparent py-2 font-display !text-[28px] !font-bold leading-tight tracking-[-0.02em] text-accent outline-none placeholder:text-accent/80 sm:min-w-[180px] sm:py-2.5 sm:text-[clamp(24px,2.4vw,30px)]"
          />
        </div>
        <button
          type="submit"
