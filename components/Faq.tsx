        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full items-center justify-between gap-6 px-7 py-6 text-left font-display text-[clamp(19px,2.2vw,25px)] font-bold tracking-[-0.03em] text-[#111]"
            >
              <span>{q.vraag}</span>
              <span
