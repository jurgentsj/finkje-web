        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full items-center justify-between gap-6 px-7 py-6 text-left font-display text-[23px] font-medium tracking-[-0.045em] text-[#111] md:text-[26px]"
            >
              <span
                className={
