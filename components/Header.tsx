          ...
          <nav className="ml-auto hidden flex-wrap items-center justify-end gap-1.5 text-[15px] font-medium lg:flex">
            {links.map((l) => (
              <Link
                key={l.href}
                href={l.href}
                className="rounded-full px-3.5 py-2.5 text-[15px] text-black/65 transition-colors hover:bg-black/5 hover:text-black"
              >
                {l.label}
              </Link>
            ))}
            {!loading && role ? (
              ...
              <>
                ...
                <Link
                  href="/aanmelden"
                  className="ml-2 rounded-full bg-accent px-[22px] py-3 text-[15px] font-semibold text-white transition-colors hover:bg-black"
                >
                  Aanmelden
                </Link>
              </>
