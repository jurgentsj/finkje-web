    ...
    <>
      <section className="mx-auto w-full max-w-[1360px] overflow-hidden px-4 pt-10 sm:px-6 sm:pt-16">
        <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,300px),1fr))] items-start gap-10 lg:items-center lg:gap-12">
          <div>
            <h1 className="m-0 mt-7 max-w-[13ch] font-display text-[clamp(49px,7vw,89px)] leading-[0.9] font-medium tracking-[-0.071em] sm:max-w-[16ch]">
      ...
      <section className="mx-auto max-w-[1360px] px-4 pt-16 sm:px-6 sm:pt-24">
        <div className="flex flex-col gap-8 border-b border-black/15 pb-7 sm:flex-row sm:items-end sm:justify-between">
          <h2 className="m-0 max-w-[20ch] font-display text-[34px] leading-[0.96] font-medium tracking-[-0.045em] sm:text-[52px]">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,290px),1fr))] gap-x-14">
          {redenen.map((r) => (
            <div key={r.titel} className="flex flex-col gap-2.5 border-b border-black/10 py-7.5">
              ...
              <h3 className="m-0 font-display text-[clamp(19px,2vw,24px)] leading-tight font-medium tracking-[-0.03em]">
                {r.titel}
              </h3>
