...
export default function WerkgeverRegistrerenPage() {
  return (
    <section className="mx-auto flex min-h-[calc(100vh-7rem)] max-w-[1360px] flex-col gap-10 px-4 py-8 sm:gap-16 sm:px-10 sm:py-20 lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)] lg:items-center lg:gap-24 lg:px-12">
      <div className="flex flex-col justify-center gap-16 lg:min-h-[540px] lg:py-8">
        <div className="hidden max-w-[680px] sm:block">
          <p className="mt-0 max-w-[46ch] text-[19px] leading-relaxed font-semibold text-black sm:mt-8 sm:text-xl">
            Maak je volgende aanstelling op motivatie. Finkje brengt je in contact met gemotiveerde mensen die weten wat zij willen.
          </p>
        </div>
        <p className="m-0 text-sm text-black/45 sm:block hidden">© 2026 Finkje</p>
      </div>
