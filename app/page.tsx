  ...
  return (
    <>
      ...
      <section className="finkje-hero-critical relative mx-auto w-full max-w-[1360px] px-6 pt-8 sm:pt-12">
        <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(280px,420px)]">
          <div className="flex min-w-0 flex-col items-start">
            <div>
              <h1 className="m-0 mt-7 font-display text-[clamp(48px,9.82vw,108px)] leading-[0.88] font-bold tracking-[-0.077em] text-[#111]" style={{ letterSpacing: "-0.077em" }}>
      ...
      <section className="mx-auto max-w-[1360px] px-6 pt-18 pb-18">
        <h2 className="m-0 mb-14 max-w-[16ch] font-display text-[clamp(32px,9vw,74px)] leading-[0.96] font-bold tracking-[-0.05em] text-[#111] text-balance">
        ...
        <div className="flex flex-col gap-12 rounded-[32px] bg-white p-8 sm:p-14 lg:p-16">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-16">
            <div className="flex flex-col gap-4.5">
              ...
              <h2 className="m-0 max-w-[16ch] font-display text-[clamp(32px,9vw,74px)] leading-[0.96] font-bold tracking-[-0.05em] text-[#111] text-balance">
