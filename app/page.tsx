  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-[1360px] px-6 py-18">
        <h2 className="m-0 mb-14 max-w-[40ch] font-display text-[clamp(32px,5vw,70px)] leading-[0.96] font-semibold tracking-[-0.081em]">
        ...
        <div className="flex flex-col gap-10 rounded-[32px] bg-sand p-8 sm:p-16">
          <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,340px),1fr))] items-center gap-10">
            <div className="flex flex-col gap-4.5">
              ...
              <h2 className="m-0 max-w-[16ch] font-display text-[clamp(34px,5.2vw,73px)] leading-[0.92] font-semibold tracking-[-0.054em]">
